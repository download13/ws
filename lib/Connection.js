...
var MSG_SIZE_LIMIT = 10485760; // Don't accept messages larger than 10 MiB
var BUFFER_SIZE_LIMIT = 2097152; // Don't allow the incoming assembly buffer to exceed 2 MiB
var OUT_FRAME_LIMIT = 131072; // Fragment outgoing messages into 128 KiB frames
...
Connection.prototype._closeHandler = function() {
	this.closeReason = 0;
	this._finishClose();
}
Connection.prototype._timeoutHandler = function() {
	this.closeReason = 0;
	this._finishClose();
}
